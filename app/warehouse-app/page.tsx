...
// // In warehouse-app/page.tsx

// // You have two fetchJobCards functions. Let's combine them into one.

// // Place this function INSIDE your WarehouseApp component body
// const fetchJobCards = async () => {
//   try {
//     setError(null);
//     setLoading(true);

//     // ✅ FETCH FROM YOUR OWN PROXY ROUTE
//     const response = await fetch("/api/job-cards"); // The URL is now relative!
...
//     // Logic to select the first card if none is selected
//     if (data.length > 0 && !selectedJobCard) {
//       setSelectedJobCard(data[0]);
//     }
//      return data; // Return data for the refresh button
//   } catch (error: any) {
//     console.error("Failed to fetch job cards:", error);
//     setError("Could not load job cards. Please check your network connection and try again.");
//   } finally {
//     setLoading(false);
//   }
// };
...
// //   useEffect(() => {
// //   if (selectedJobCard) {
// //     fetch(`http://192.168.1.7:3005/api/job-cards/${selectedJobCard.mawb_number}/status`, {
// //       method: "PATCH",
// //       headers: {
...
//     const res = await fetch("http://192.168.1.7:3005/api/upload-images", {
//       method: "POST",
//       body: formData,
//     })
...
//     const response = await fetch("http://192.168.1.7:3005/api/warehouse-report", {
//       method: "POST",
...
//       try {
//         const res = await fetch(`http://192.168.1.7:3005/api/report/send-email/${selectedJobCard.mawb_number}`, {
//           method: "POST",
//         });
...
// import { SignatureSection } from "@/components/SignatureSection"
// import SignaturePad from "signature_pad"
// import { Search, Eye, Plus, Upload, Send, LayoutDashboard, Settings, HelpCircle, CheckCircle, Trash2, RefreshCcw } from "lucide-react"
// import { Button } from "@/components/ui/button"
// import { Input } from "@/components/ui/input"
// import { Label } from "@/components/ui/label"
// import { Textarea } from "@/components/ui/textarea"
...
// // ✅ Type Definitions moved outside the component for better practice
// type JobCard = {
//   id: number
//   mawb_number: string
//   hawb_number: string
...
//   // ✅ Consolidated and robust function to fetch job cards
//   const fetchJobCards = async () => {
//     setIsLoading(true)
//     setFetchError(null)
//     try {
//       // Fetch from the internal Next.js proxy route to avoid CORS errors
//     const response = await fetch("http://192.168.1.7:3005/api/job-cards");
...
//       // Only set a selected card if one isn't already selected or if the list is new
//       if (data.length > 0 && !selectedJobCard) {
//         setSelectedJobCard(data[0])
//       }
//     } catch (error: any) {
//       console.error("Error fetching job cards:", error)
//       setFetchError("Could not load job cards. Please check the server and your network connection.")
//       toast({
//         title: "Error",
...
//   // ✅ Simplified useEffect to run the fetch function on component mount
//   useEffect(() => {
//     fetchJobCards()
//   }, [])
...
//       canvas.height = height * ratio
//       canvas.getContext("2d")?.scale(ratio, ratio)
//       sigPadRef.current = new SignaturePad(canvas, { penColor: "black", backgroundColor: "white" })
//     }
//   }, [])

//   const addItem = () => {
//     setItems([...items, { id: Date.now(), product: "", pieces: 0, topTemp: "", midTemp: "", bottomTemp: "" }])
//   }
...
//   const StatusBadge = ({ status }: { status: string }) => {
//     const variants = { Unattended: "bg-yellow-500", Opened: "bg-blue-500", Completed: "bg-green-500" }
//     return (
//       <Badge className={`${variants[status as keyof typeof variants]} text-white shadow-sm font-semibold px-2 py-1 rounded-md text-xs`}>
//         {status}
//       </Badge>
//     )
//   }
...
//   // Recommendation: Convert these fetch calls to proxy routes as well for consistency and security
//     const uploadImages = async () => {
//     const formData = new FormData()
//     images.forEach((img) => formData.append("images", img))
...
//         return new Date(b.created).getTime() - new Date(a.created).getTime()
//       }
//       return 0 // Add other sort conditions if needed
//     })
...
//   )
// }
// // NOTE: I have omitted the large JSX sections for brevity, but you should keep them in your actual file.
// // The key changes are the state management, the fetchJobCards function, the useEffect hook, and the rendering logic for the job card list.
...
//   useEffect(() => {
//   if (selectedJobCard) {
//     fetch(`http://localhost:3005/api/job-cards/${selectedJobCard.mawb_number}/status`, {
//       method: "PATCH",
//       headers: {
//         "Content-Type": "application/json",
//       },
